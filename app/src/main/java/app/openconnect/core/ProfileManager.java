...
public class ProfileManager {
    ...
    private static final String ON_BOOT_PROFILE2 = "onBootProfile2";
    ...
    public synchronized static void setConnectedVpnProfile(VpnProfile connectedProfile) {
        ...
        mAppPrefs.edit()
                ...
                .putString(ON_BOOT_PROFILE2, connectedProfile.getUUIDString())
                .commit();
    }
    ...
    public synchronized static VpnProfile getOnBootProfile2() {
        return get(mAppPrefs.getString(ON_BOOT_PROFILE2, null));
    }
